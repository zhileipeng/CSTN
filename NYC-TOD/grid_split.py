...
#     plot_grid()
#
#     # gmap = gmplot.GoogleMapPlotter(30.727818, 104.043333, 12)
#     # gmap.draw("cd.html")
#
import math
import pandas as pd
...
def getGirdDict(grid_map=(5, 15)):
    '''
        for Chengdu
    '''
    _upleft = (727.818, 43.333)
    _upright = (726.490, 129.076)  # not used
    _downleft = (652.828, 42.102)
    _downright = (655.191, 129.591)
    pad_longitube = 104
    pad_latitube = 30
    scale_longitube = 1e3
    scale_latitube = 1e3
...
def plot_grid():
    ...
    keys = grid_dict.keys()
    ''' for new york '''
    gmap = gmplot.GoogleMapPlotter(30.692139, 104.089047, 12)
